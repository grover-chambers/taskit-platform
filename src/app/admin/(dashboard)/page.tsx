    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-px bg-midnight-700 rounded-2xl overflow-hidden border border-midnight-700 mb-6">
        <div className="bg-midnight-800 p-4 border-r border-b border-midnight-700">
          <div className="font-bold text-xl text-gold-500">KSh {(stats?.revenue || 0).toLocaleString()}</div>
        ...
        <div className="bg-midnight-800 p-4 border-b border-midnight-700">
          <div className="font-bold text-xl text-white">{stats?.ordersToday || 0}</div>
        ...
        <div className="bg-midnight-800 p-4 border-r border-midnight-700">
          <div className="font-bold text-xl text-white">{stats?.ridersOnline || 0}</div>
        ...
        <div className="bg-midnight-800 p-4">
          <div className="font-bold text-xl text-white">{stats?.completionRate || 96}%</div>
          ...
          {liveOrders.slice(0, 5).map((order: any) => (
            <div key={order.id} className="flex items-center gap-2.5 py-2 border-b border-midnight-700 last:border-b-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-white text-xs font-semibold">{order.errandDescription}</div>
                <div className="text-gray-500 text-[9.5px]">Rider: {order.rider?.name} · {order.rider?.riderDetail?.plateNumber}</div>
              </div>
